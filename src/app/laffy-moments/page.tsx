    ...
    return (
      <div className="group relative transition duration-500 hover:-translate-y-2 h-full">
        ...
        <div className="relative bg-black/60 backdrop-blur-sm rounded-xl overflow-hidden border border-cyan-500/30 group-hover:border-teal-500/50 transition duration-300 h-full flex flex-col">
          {rank && (
            <div className="absolute top-2 left-2 z-30 bg-gradient-to-r from-cyan-500 to-teal-500 rounded-full w-10 h-10 flex items-center justify-center shadow-lg border-2 border-white/20">
              <span className="text-white font-black text-lg">{rank}</span>
            </div>
          )}
            ...
            <div className="instagram-embed-wrapper min-h-[450px] relative">
              ...
              {embedUrl ? (
                <>
                  ...
                  >
                    <div className="bg-gradient-to-r from-cyan-600 to-teal-600 rounded-xl px-6 py-3 transform scale-90 group-hover:scale-100 transition-transform duration-300">
