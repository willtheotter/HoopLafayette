  ...
  if (isMobile) {
    return (
      <div className="group relative transition duration-500 hover:-translate-y-2 h-full">
        ...
        <div className="relative bg-black/60 backdrop-blur-sm rounded-xl overflow-hidden border border-cyan-500/30 group-hover:border-blue-500/50 transition duration-300 h-full flex flex-col">
          <div className="p-6 flex-1 flex flex-col items-center justify-center text-center">
            <p className="text-sm font-bold text-cyan-400 mb-3">@{username}</p>
            
            <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-cyan-500 to-blue-500 flex items-center justify-center mb-4">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 rounded-xl hover:from-cyan-500 hover:to-blue-500 transition-all duration-300 transform hover:scale-105 mb-3"
            >
      ...
      <div className="group relative transition duration-500 hover:-translate-y-2 h-full">
        ...
        <div className="relative bg-red-500/10 backdrop-blur-sm rounded-xl border border-red-500/30 p-6 text-center h-full flex flex-col items-center justify-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-400 text-sm underline hover:text-cyan-400 transition"
          >
            View on Instagram →
          </a>
        </div>
      ...
      <div className="relative bg-black/60 backdrop-blur-sm rounded-xl overflow-hidden border border-cyan-500/30 group-hover:border-blue-500/50 transition duration-300 h-full flex flex-col">
        <div className="p-4 flex-1 flex flex-col">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 text-blue-400 text-xs hover:text-cyan-400 transition-colors flex items-center gap-1 shrink-0"
          >
