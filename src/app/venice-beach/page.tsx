            ...
            <div className="instagram-embed-wrapper min-h-[450px] relative">
              ...
              {embedUrl ? (
                <>
                  ...
                  >
                    <div className="bg-gradient-to-r from-cyan-600 to-blue-600 rounded-xl px-6 py-3 transform scale-90 group-hover:scale-100 transition-transform duration-300">
